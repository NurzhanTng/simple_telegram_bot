...
from core.handlers import send_media, basic, callback, contact, form, pay
...
def create_scheduled_tasks(bot: Bot, scheduler: AsyncIOScheduler):
...
async def main(): 
  ...
  # create_scheduled_tasks(bot, scheduler)
  scheduler.start()
  dp = Dispatcher()
  ...
  dp.include_routers(send_media.router, basic.router, callback.router, contact.router, form.router, pay.router)
