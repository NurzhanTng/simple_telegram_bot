...
@router.message(Command(commands='audio'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='document'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='mediagroup'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='photo'), flags={ 'chat_action': 'upload_document' })
async def get_photo(message: Message, bot: Bot):
  photo = FSInputFile(path=r'C:\\Users\\ПК\\Pictures\\0001.jpg')
  await bot.send_photo(message.chat.id, photo=photo)


@router.message(Command(commands='sticker'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='video'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='video_note'), flags={ 'chat_action': 'upload_document' })
...
@router.message(Command(commands='voice'), flags={ 'chat_action': 'upload_document' })
